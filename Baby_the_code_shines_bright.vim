...
hi cssColor  guifg=#DE99BF ctermfg=175 guibg=NONE gui=NONE
hi cssPseudoClass guifg=#B3F382 ctermfg=156 guibg=NONE gui=NONE
hi cssPseudoClassId  guifg=#B3F382 ctermfg=156 guibg=NONE gui=NONE
hi cssClassName  guifg=#5BB5D0 ctermfg=74  guibg=NONE gui=NONE
hi cssValueLength  guifg=#F46CB8 ctermfg=205 guibg=NONE gui=NONE
hi cssValueNumber  guifg=#F46CB8 ctermfg=205 guibg=NONE gui=NONE
hi cssFunction guifg=#4B7FD4 ctermfg=68 guibg=NONE gui=NONE
hi cssFunctionName  guifg=#de99bf ctermfg=175  guibg=NONE gui=NONE
hi cssMedia guifg=#8693A5 ctermfg=103 guibg=NONE gui=NONE
hi cssCommonAttr  guifg=#DE99BF ctermfg=175 guibg=NONE gui=NONE
hi cssBraces  guifg=NONE guibg=NONE gui=NONE
hi cssIdentifier  guifg=#61c8c3 ctermfg=79  guibg=NONE gui=NONE
hi cssTagName guifg=#9CEFF2 ctermfg=159  guibg=NONE gui=NONE
